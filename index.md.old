...
I have been wanting to learn Rust for quite a while now.  I've jealously eyed how [Rust often overtakes C++ in performance]([Rust vs G^M^M vs C^N.xlsx](https://1drv.ms/x/s!At7D0T4Uz1vyjM8AlDMCWKyIYS1cOQ?e=Lv5fnM)) while C# lags behind the "fast three (C/C++/Rust)" in benchmarks.  Every time C# gets faster, so does Rust.  It's not fair!
